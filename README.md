...
Initially created a series of scatter plots to showcase the following relationships:
...
Used my skills in working with weather data to plan future vacations. 
